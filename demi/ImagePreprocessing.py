...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  7 13:30:12 2018
...
#    plt.figure()
#    plt.gray()
#    plt.title('background correction using square')
...
def bckgrnd_correc_sq(image, length):
    ...
    assert type(length) == int, ('Wrong data type', 'length of the square structuring element must be a int')
...
def bckgrnd_correc_disk(image, radius):
    ...
    # Checking the right data type for the length of the square structuring element
    assert type(radius) == int, ('Wrong data type', 'radius of the disk structuring element must be a int')
    ...
    # plotting image
#    plt.figure()
#    plt.title('background correction using disk')
#
#    plt.gray()
#    plt.imshow(image_bckgrnd_corrected)
#    plt.colorbar()
...
def convert_to_grayscale(image):
    ...
    # plotting the image
    plt.figure()
    plt.title('converted to grey scale')
    plt.gray()
